...
namespace Plugins {
	...
	static PyMemberDef CValue_members[] = {
		{ "ID",	T_LONG, offsetof(CValue, ValueID), READONLY, "Internal Value Number" },
		{ "Name", T_LONG,	offsetof(CValue, Name), READONLY, "Name" },
		...
		{ "RetentionDays", T_LONG, offsetof(CValue, RetentionDays), READONLY, "Device this Value relates to" },
		{ "RetentionInterval", T_LONG, offsetof(CValue, RetentionInterval), READONLY, "Device this Value relates to" },
